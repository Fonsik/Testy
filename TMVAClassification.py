...
DEFAULT_METHODS  = "Likelihood,LikelihoodD,LikelihoodPCA,MLP,BDT"
...
def main():
    ...
    # Output file
    outputFile=TFile(  "TMVApy.root", "RECREATE" )
    ...
    input = TFile.Open( "~/Test/Testy/out_bkg.root" )
    signal      = input.Get( "ntuple" )
    input = TFile.Open( "~/Test/Testy/out_bkg.root" )
    background  = input.Get("ntuple" )
