...
DEFAULT_INFNAME  = "~/Test/Testy/out_bkg.root"
DEFAULT_TREESIG  = "TreeS"
DEFAULT_TREEBKG  = "TreeB"
#DEFAULT_METHODS  = "Cuts,CutsD,CutsPCA,CutsGA,CutsSA,Likelihood,LikelihoodD,LikelihoodPCA,LikelihoodKDE,LikelihoodMIX,PDERS,PDERSD,PDERSPCA,PDEFoam,PDEFoamBoost,KNN,LD,Fisher,FisherG,BoostedFisher,HMatrix,MLP,MLPBFGS,MLPBNN,CFMlpANN,TMlpANN,SVM,BDT,BDTD,BDTG,BDTB,RuleFit"
#DEFAULT_METHODS  = "Likelihood,LikelihoodD,LikelihoodPCA,MLP,BDT,Keras"
...
def main():
 ...
 # Book methods
    ...
    if "Keras" in mlist:
        ...
        factory.BookMethod(dataloader, TMVA.Types.kPyKeras, "PyKeras","H:!V:VarTransform=D,G:FilenameModel=model.h5:NumEpochs=20:BatchSize=32")
    # --------------------------------------------------------------------------------------------------
